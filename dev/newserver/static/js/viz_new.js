        ...
        var NetworkViz = (function () {
            function NetworkViz(settings, for_guestbook) {
                ...
                if (!this.guestbook && d3.select("#network").select("image")[0][0] == null) {
                    this.svg.append("svg:image").attr("id", "logo").attr("width", 193).attr("height", 40).attr("xlink:href", "/static/images/basic-url-logo2.png").attr("x", 10).attr("y", 18).attr("opacity", 0.8);
                }
            }
...
//                d3.select("#links").remove(); d3.select("#nodes").remove();
                ...
                this.guestbook = for_guestbook;
                if (!this.guestbook && d3.select("#network").select("image")[0][0] == null) {
                    this.svg.append("svg:image").attr("id", "logo").attr("width", 250).attr("height", 35).attr("xlink:href", "/static/images/basic-url-logo2.png").attr("x", 10).attr("y", 18).attr("opacity", 0.8);
                }
            }
